...
export const getApiUserCart: any = createAsyncThunk(
  'cart/getApiUserCart',
  async (idUser: number) => {
    const response = await axios.get(`${Endpoint.usersCart}/${idUser}`);
...
export const setApiUserCart: any = createAsyncThunk(
  'cart/setApiUserCart',
  async ({
    id,
    products,
...
export const deleteApiUserCart: any = createAsyncThunk(
  'cart/deleteApiUserCart',
  async ({ idUser, idProduct }: { idUser: number; idProduct: number }) => {
    if (idProduct) {
      let response = await axios.delete(Endpoint.usersCart, {
        data: {
          id_user: idUser,
      ...
      let response = await axios.delete(`${Endpoint.usersCart}/all`, {
        data: {
          id_user: idUser,
        },
      });
...
export const updateApiUserCart: any = createAsyncThunk(
  'cart/updateApiUserCart',
  async ({
    idUser,
    idProduct,
    quantity,
    ...
    let response = await axios.put(Endpoint.usersCart, {
      id_user: idUser,
      id_product_details: idProduct,
      id_size,
      quantity,
