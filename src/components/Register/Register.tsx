...
import { Endpoint, PublicRoutes } from '@/routes/routes';
...
const validations = yup.object().shape({
  ...
  password: yup
    ...
    .min(8, 'Password length must be of minimun 8 chars'),
  phone: yup
    .string()
    .min(10, 'Minimun number length is 10')
    .max(10, 'Maximun number length is 10')
      ...
      <Box component='form' noValidate={false} onSubmit={formik.handleSubmit} sx={{ mt: 3 }}>
        <Paper elevation={10} style={paperstyle}>
          ...
          <TextField
            ...
            helperText={formik.touched.identification && formik.errors.identification}></TextField>
